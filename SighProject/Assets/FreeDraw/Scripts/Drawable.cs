...
// BRUSH TYPES. Implement your own here
        ...
        public void BrushTemplate(Vector2 world_position)
        {
            ...
            else
            {
                ...
                Debug.Log("THE USER IS DRAGGING");
            }
            ////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////
        ...
        void Update()
        {
            if (ApplicationManager.instance.SetSignMode)
            {
                ...
                if (mouse_held_down && !no_drawing_on_current_drag)
                {
                    ...
                    Vector2 mouse_world_position = drawingCamera.ScreenToWorldPoint(Input.mousePosition);


                    // Check if the current mouse position overlaps our image
                    Collider2D hit = Physics2D.OverlapPoint(mouse_world_position, Drawing_Layers.value);
                    Debug.Log("Drawing_Layers.value : " + Drawing_Layers.value);
                    Debug.Log("mouse_world_positionX : " + mouse_world_position.x + " mouse_world_positionY : " + mouse_world_position.y);
                    if (hit != null && hit.transform != null)
                    {
                        // We're over the texture we're drawing on!
                        // Use whatever function the current brush is
                        current_brush(mouse_world_position);
                        Debug.Log("current_brush");
                    }
                    ...
                    else
                    {
                        ...
                        if (!mouse_was_previously_held_down)
                        {
                            ...
                            Debug.Log("no_drawing_on_current_drag");
                        }
                    }
                }
                // Mouse is released
        ...
        public void MarkPixelToChange(int x, int y, Color color)
        {
            ...
            //Debug.Log("MarkPixelToChange");

            cur_colors[array_pos] = color;
        }
        public void ApplyMarkedPixelChanges()
        {
            Debug.Log("ApplyMarkedPixelChanges");
